const translate = {
    "ru": {
        "welcome__wel": "Добро пожаловать в&nbsp;метасеть",
        "welcome__text": "Играй, созидай, властвуй!",
        "welcome__join": "Вступить в&nbsp;cообщество",
        "about__title": "О проекте",
        "about__info": "<p>Мы хотели выпендриться и&nbsp;придумали крутой проект: Titimiti — первую в&nbsp;мире метасеть , объединяющую De-fi, Game-fi и Social-fi в&nbsp;единую экономическую систему будущего.</p><p>Азарт и&nbsp;жадность человеческих индивидов мы превратим в&nbsp;\"цифровое золото\", работающее во&nbsp;благо всего сообщества. </p> <p>Так наши комплексы изменят будущее человечества.</p>",
        "about__title2": "Миссия",
        "about__info2": "<p>Выйти за&nbsp;рамки человеческих возможностей.</p><p>Это предполагает создание революционной геймифицированной социально-экономической системы. Которая включает в&nbsp;себя разработку инновационной структуры основанной на&nbsp;блокчейн технологии, геймдизайне и&nbsp;механики игр для привлечения и&nbsp;мотивации пользователей. </p> <p> Цель состоит в&nbsp;том, чтобы построить механизмы одновременно интересные и&nbsp;функциональные,",
        "titiland__text": "<p>Мир давно поделили, но&nbsp;мы поняли что его можно поделить ещё раз.</p><p>И сотворили Titiland, разделив виртуальную карту планеты Земля на&nbsp;равные участки суши и&nbsp;воды. </p> <p> Каждый из этих участков является NFT токеном и&nbsp;в&nbsp;свою очередь ключевым активом в&nbsp;экосистеме TitiMiti. Держатели этих токенов получают эксклюзивный статус и&nbsp;заработок от&nbsp;монетизации всего проекта. </p>",
        "titiland__btntxt": "Подробнее",
        "zoomloop__opentxt": "Открой новый мир",
        ...
        "email__entertxt": "Введи свою электронную почту",
        "email__name": "Получай новости первым",
        "email__ertxt": "Некорректно введена почта",
        "form__btntxt": "Отправить",
        "helpus__txt": "Помоги нам и получи за это бонусы",
        "helpus__name": "Стань исследователем",
        "helpus__info": "У тебя будет возможность...<br>За это ты будешь получать...<br>И еще какое-то описание<br>",
        "helpus__btntxt": "Подробнее",
        "popup__txt": "Страница еще в разработке",
        "popup__btntxt": "Закрыть",
        "popup_email_text": "Вы успешно подписались<br>на рассылку",
        "popup_email_btntxt": "Закрыть",
        "cookie__text": "Этот сайт использует cookies, хоть мы и не пекарня",
        "cookie__btntxt": "Хорошо",
